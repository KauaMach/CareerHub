    ...
    <div className="relative min-h-screen flex flex-col overflow-hidden selection:bg-primary selection:text-primary-foreground">
      ...
      <header className="relative z-10 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/40">
        <div className="container mx-auto flex h-16 items-center justify-between px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight">CareerHub</span>
          </div>
          <div className="flex items-center gap-6">
            ...
            <ThemeSwitcher />
            <Link href="/login" className="inline-flex h-9 items-center justify-center rounded-full bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-transform hover:scale-105 active:scale-95">
              Entrar
            </Link>
          </div>
        </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 py-24 sm:py-32">
        <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-8 backdrop-blur-sm animate-fade-in">
          ...
          <span className="animate-pulse">Acelere a sua carreira</span>
        </div>
        ...
        <p className="max-w-2xl text-lg sm:text-xl text-muted-foreground mb-10 animate-in slide-in-from-bottom-6 duration-700 delay-150">
          O CareerHub centraliza suas aplicações, otimiza seus currículos e acompanha seu progresso nas entrevistas. O sistema operacional definitivo para a sua jornada profissional.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 animate-in slide-in-from-bottom-8 duration-700 delay-300">
          <Link href="/register" className="inline-flex h-12 items-center justify-center rounded-full bg-primary px-8 text-base font-medium text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:scale-105 hover:bg-primary/90 active:scale-95">
            Começar
        ...
        <div id="features" className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-4 text-left animate-in fade-in duration-1000 delay-500">
          {/* Card 1 */}
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-border/50 bg-background/40 backdrop-blur-xl p-8 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-indigo-500/10 hover:border-indigo-500/30">
            ...
            <p className="text-muted-foreground">Crie e adapte seu currículo para cada vaga específica. Tenha todo o seu histórico salvo.</p>
          </div>
